...
import com.aviapp.app.security.applocker.data.database.callblocker.addtoblacklist.AddToBlackListViewModel
import com.aviapp.app.security.applocker.di.ViewModelFactory
import com.aviapp.app.security.applocker.di.key.ViewModelKey
import com.aviapp.app.security.applocker.ui.background.BackgroundsActivityViewModel
import com.aviapp.app.security.applocker.ui.background.BackgroundsFragmentViewModel
import com.aviapp.app.security.applocker.ui.browser.BrowserViewModel
import com.aviapp.app.security.applocker.ui.browser.bookmarks.BookmarksViewModel
import com.aviapp.app.security.applocker.ui.callblocker.CallBlockerViewModel
import com.aviapp.app.security.applocker.ui.callblocker.blacklist.BlackListViewModel
import com.aviapp.app.security.applocker.ui.callblocker.blacklist.delete.BlackListItemDeleteViewModel
import com.aviapp.app.security.applocker.ui.callblocker.log.CallLogViewModel
import com.aviapp.app.security.applocker.ui.intruders.IntrudersPhotosViewModel
import com.aviapp.app.security.applocker.ui.main.MainViewModel
import com.aviapp.app.security.applocker.ui.newpattern.CreateNewPatternViewModel
import com.aviapp.app.security.applocker.ui.overlay.activity.OverlayValidationViewModel
import com.aviapp.app.security.applocker.ui.permissiondialog.UsageAccessPermissionViewModel
import com.aviapp.app.security.applocker.ui.permissions.PermissionsViewModel
import com.aviapp.app.security.applocker.ui.policydialog.PrivacyPolicyViewModel
import com.aviapp.app.security.applocker.ui.rateus.RateUsViewModel
import com.aviapp.app.security.applocker.ui.security.SecurityViewModel
import com.aviapp.app.security.applocker.ui.settings.SettingsViewModel
import com.aviapp.app.security.applocker.ui.vault.VaultViewModel
import com.aviapp.app.security.applocker.ui.vault.addingvaultdialog.AddToVaultViewModel
import com.aviapp.app.security.applocker.ui.vault.removingvaultdialog.RemoveFromVaultViewModel
