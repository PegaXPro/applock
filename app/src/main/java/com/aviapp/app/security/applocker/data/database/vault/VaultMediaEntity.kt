package com.aviapp.app.security.applocker.data.database.vault
...
data class VaultMediaEntity(
    ...
    fun getEncryptedPreviewFileNameBig(): String {
        val slashIndex = encryptedPreviewPath.lastIndexOf('/')
        return encryptedPreviewPath.substring(slashIndex + 1) + "big"
    }
}