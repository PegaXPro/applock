package com.aviapp.app.security.applocker.service.notification
...
class ServiceNotificationManager @Inject constructor(val context: Context) {
    ...
    fun createPermissionNeedNotification(): Notification {
        ...
        val sound: Uri =
            Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + context.packageName + "/" + R.raw.emergency_alert)
